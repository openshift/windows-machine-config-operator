...
source "vsphere-iso" "windows-server-2022" {
  ...
  firmware             = "bios"
  floppy_files         = ["answer-files/autounattend.xml", "answer-files/unattend.xml", "scripts/authorized_keys", "scripts/install-vm-tools.cmd", "scripts/configure-vm-tools.ps1", "scripts/install-openssh.ps1"]
