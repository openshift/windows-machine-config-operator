...
is not included. This is a requirement of the [hybrid OVN Kubernetes networking with a custom VXLAN port](https://docs.redhat.com/container-platform/latest/networking/ovn_kubernetes_network_provider/configuring-hybrid-networking.html) feature.*
...
[OpenShift infrastructure requirements](https://docs.redhat.com/container-platform/latest/installing/installing_vsphere/preparing-to-install-on-vsphere.html#installation-vsphere-infrastructure_preparing-to-install-on-vsphere).
