...
[OVNKubernetes hybrid networking](https://docs.redhat.com/container-platform/latest/networking/ovn_kubernetes_network_provider/configuring-hybrid-networking.html) is the only supported networking configuration.
...
| VMware vSphere | Hybrid OVNKubernetes with a [Custom VXLAN port](https://docs.redhat.com/container-platform/latest/networking/ovn_kubernetes_network_provider/configuring-hybrid-networking.html) |
