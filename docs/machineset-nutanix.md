...
For the general Nutanix MachineSet `providerSpec` configuration, refer to the OpenShift document [creating machineset nutanix](https://docs.redhat.com/container-platform/latest/machine_management/creating_machinesets/creating-machineset-nutanix.html).
```
