...
should have been created as part of the [cluster install](https://docs.redhat.com/container-platform/latest/installing/installing_nutanix/installing-nutanix-installer-provisioned.html).
