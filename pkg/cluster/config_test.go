...
func TestIsValidKubernetesVersion(t *testing.T) {
	...
	var tests = []struct {
		...
		{"cluster version equals supported version", "v1.25.0", false},
		{"cluster version equals supported version", "v1.26.4", false},
		{"cluster version greater than supported version ", "v1.27.2", true},
	}
