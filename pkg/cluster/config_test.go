...
func TestIsValidKubernetesVersion(t *testing.T) {
	...
	var tests = []struct {
		...
		{"cluster version equals supported version", "v1.31.0", false},
		{"cluster version equals supported version", "v1.32.4", false},
		{"cluster version greater than supported version ", "v1.33.2", true},
	}
