...
func TestIsValidKubernetesVersion(t *testing.T) {
	...
	var tests = []struct {
		...
		{"cluster version equals supported version", "v1.28.0", false},
		{"cluster version equals supported version", "v1.29.4", false},
		{"cluster version greater than supported version ", "v1.30.2", true},
	}
