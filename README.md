...
WMCO does support upgrading from one EUS version to another EUS version of OCP, the Windows nodes will be upgraded 
from the staring EUS to the new EUS version while keeping the Windows workload in a healthy state with no disruptions.
