...
RUN sed -i "s|REPLACE_IMAGE|registry.redhat.io/openshift4-wincw/windows-machine-config-rhel9-operator:10.18.0|g" /manifests/windows-machine-config-operator.clusterserviceversion.yaml
