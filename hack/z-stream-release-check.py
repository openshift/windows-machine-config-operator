...
def fetch_unreleased_prs(last_tag: str, branch: str, tick=None) -> dict:
    ...
    # Capture pass-1 total before pass-2 reclassifies some team PRs as bot.
    pass1_total = len(team_pr_numbers) + bot_filtered
    team_prs = []
...
""",
    ...
    try:
        ...
        print(f"\nERROR: Failed to fetch GitHub branches: {exc}", file=sys.stderr)
        sys.exit(2)
